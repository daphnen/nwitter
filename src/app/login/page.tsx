    ...
    <main className="mx-auto flex min-h-dvh max-w-md flex-col items-center justify-center px-5 py-10">
      <div className="w-full rounded-card border-2 border-line bg-card px-7 py-9 shadow-card">
        <div className="flex flex-col items-center text-center">
          <CatMascot size={96} />
          <h1 className="mt-3 text-title">우리의 대시보드</h1>
          <p className="mt-1 text-heading text-muted">
            둘만 들어올 수 있어요 🐾
          </p>
        </div>
        ...
        {error ? (
          <p
            role="alert"
            className="mt-5 rounded-inner bg-tone-orange-soft px-4 py-3 text-center text-label"
          >
            {error}
          </p>
        ) : null}
        ...
        <p className="mt-6 text-center text-label leading-relaxed text-muted">
